...
const handler = () => {
    blogStroe.modifyHandler({id : route.params.id, ...blogStore.detailsBlog.value })
}
const deleteMethod = () =>{
    ...
    <div class="blogContainer">
        ...
        <div class="content" v-else>
            ...
            <div class="imgContainer">
                ...
                <img class="imgBox" :src="blogStore.detailsBlog.value.img" :alt="blogStroe.detailsBlog.value.title" />
            </div>
        </div>
